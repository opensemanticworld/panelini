...
(t.charCodeAt(2) > 122 || t.charCodeAt(2) < 97), vn = (t) => t.startsWith("onUpdate:"), re = Object.assign, li = (t, e) => {
  const n = t.indexOf(e);
  n > -1 && t.splice(n, 1);
}, Lr = Object.prototype.hasOwnProperty, H = (t, e) => Lr.call(t, e), D = Array.isArray, gt = (t) => Xt(t) === "[object Map]", yo = (t) => Xt(t) === "[object Set]", Mi = (t) => Xt(t) === "[object Date]", F = (t) => typeof t == "function", ee = (t) => typeof t == "string", Fe = (t) => typeof t == "symbol", A = (t) => t !== null && typeof t == "object", xo = (t) => (A(t) || F(t)) && F(t.then) && F(t.catch), wo = Object.prototype.toString, Xt = (t) => wo.call(t), Ar = (t) => Xt(t).slice(8, -1), ko = (t) => Xt(t) === "[object Object]", ci = (t) => ee(t) && t !== "NaN" && t[0] !== "-" && "" + parseInt(t, 10) === t, Ot = /* @__PURE__ */ si(
...
function fi(t, e) {
  ...
  if (n = A(t), i = A(e), n || i) {
    ...
    if (o !== r)
      return !1;
    for (const s in t) {
      const l = t.hasOwnProperty(s), c = e.hasOwnProperty(s);
      if (l && !c || !l && c || !fi(t[s], e[s]))
        return !1;
    }
  }
  return String(t) === String(e);
}
const No = (t) => !!(t && t.__v_isRef === !0), So = (t) => ee(t) ? t : t == null ? "" : D(t) || A(t) && (t.toString === wo || !F(t.toString)) ? No(t) ? So(t.value) : JSON.stringify(t, Po, 2) : String(t), Po = (t, e) => No(e) ? Po(t, e.value) : gt(e) ? {
  [`Map(${e.size})`]: [...e.entries()].reduce(
    (n, [i, o], r) => (n[Mn(i, r) + " =>"] = o, n),
    {}
  )
} : yo(e) ? {
  [`Set(${e.size})`]: [...e.values()].map((n) => Mn(n))
} : Fe(e) ? Mn(e) : A(e) && !D(e) && !ko(e) ? String(e) : e, Mn = (t, e = "") => {
  var n;
  return (
...
class Io {
  ...
  run() {
    if (!(this.flags & 1))
      return this.fn();
    this.flags |= 2, Ki(this), Oo(this);
    const e = G, n = ke;
    G = this, ke = !0;
    try {
      return this.fn();
    } finally {
      Co(this), G = e, ke = n, this.flags &= -3;
    }
  }
  stop() {
    if (this.flags & 1) {
...
function Xn(t) {
  for (let e = t.deps; e; e = e.nextDep)
    if (e.dep.version !== e.version || e.dep.computed && (Mo(e.dep.computed) || e.dep.version !== e.version))
      return !0;
  return !!t._dirty;
}
function Mo(t) {
...
class Ko {
  ...
  track(e) {
    ...
    if (n === void 0 || n.sub !== G)
      n = this.activeLink = new os(G, this), G.deps ? (n.prevDep = G.depsTail, G.depsTail.nextDep = n, G.depsTail = n) : G.deps = G.depsTail = n, Do(n);
...
function oe(t, e, n) {
  if (ke && G) {
    ...
    let o = i.get(n);
    o || (i.set(n, o = new Ko()), o.map = i, o.key = n), o.track();
  }
}
function Xe(t, e, n, i, o, r) {
  ...
  if (ai(), e === "clear")
    ...
    const c = D(t), a = c && ci(n);
    if (c && n === "length") {
      const f = Number(i);
      s.forEach((b, u) => {
        (u === "length" || u === Rt || !Fe(u) && u >= f) && l(b);
      });
    } else
      switch ((n !== void 0 || s.has(void 0)) && l(s.get(n)), a && l(s.get(Rt)), e) {
        case "add":
          c ? a && l(s.get("length")) : (l(s.get(ct)), gt(t) && l(s.get(Gn)));
          break;
        case "delete":
          c || (l(s.get(ct)), gt(t) && l(s.get(Gn)));
          break;
        case "set":
          gt(t) && l(s.get(ct));
          break;
...
const rs = {
  __proto__: null,
  [Symbol.iterator]() {
    return Kn(this, Symbol.iterator, (t) => Oe(this, t));
  },
  concat(...t) {
  ...
  entries() {
    return Kn(this, "entries", (t) => (t[1] = Oe(this, t[1]), t));
  },
  every(t, e) {
  ...
  reduce(t, ...e) {
    return Di(this, "reduce", t, e);
  },
  reduceRight(t, ...e) {
    return Di(this, "reduceRight", t, e);
  },
  shift() {
  ...
  values() {
    return Kn(this, "values", (t) => Oe(this, t));
  }
};
function Kn(t, e, n) {
  const i = En(t), o = i[e]();
...
function He(t, e, n, i, o, r) {
  ...
  let a = n;
  s !== t && (l ? a = function(b, u) {
    return n.call(this, Oe(t, b), u, t);
  } : n.length > 2 && (a = function(b, u) {
    return n.call(this, b, u, t);
  }));
...
const ls = /* @__PURE__ */ si("__proto__,__v_isRef,__isVue"), Wo = new Set(
...
class Fo {
  ...
  get(e, n, i) {
    ...
    if (n === "__v_isShallow")
      return r;
    if (n === "__v_raw")
      return i === (o ? r ? vs : Lo : r ? Ho : Ro).get(e) || // receiver is not the reactive proxy, but has the same prototype
    ...
    if ((Fe(n) ? Wo.has(n) : ls(n)) || (o || oe(e, "get", n), r))
      return l;
    if (/* @__PURE__ */ ae(l)) {
      const c = s && ci(n) ? l : l.value;
...
class Zo extends Fo {
  ...
  set(e, n, i, o) {
    ...
    return e === /* @__PURE__ */ L(o) && (l ? Ue(i, r) && Xe(e, "set", n, i) : Xe(e, "add", n, i)), c;
  }
  deleteProperty(e, n) {
    const i = H(e, n);
    e[n];
...
function us(t, e, n) {
  return function(...i) {
    const o = this.__v_raw, r = /* @__PURE__ */ L(o), s = gt(r), l = t === "entries" || t === Symbol.iterator && s, c = t === "keys" && s, a = o[t](...i), f = n ? Yn : e ? yt : Be;
    return !e && oe(
      r,
      "iterate",
      c ? Gn : ct
...
function hs(t, e) {
  const n = {
    get(o) {
      ...
      const { has: c } = _t(s), a = e ? Yn : t ? yt : Be;
      if (c.call(s, o))
        return a(r.get(o));
      if (c.call(s, l))
        return a(r.get(l));
    ...
    forEach(o, r) {
      const s = this, l = s.__v_raw, c = /* @__PURE__ */ L(l), a = e ? Yn : t ? yt : Be;
  ...
  return re(
    ...
    t ? {
      ...
      add(o) {
        const r = /* @__PURE__ */ L(this), s = _t(r), l = /* @__PURE__ */ L(o), c = !e && !/* @__PURE__ */ Ee(o) && !/* @__PURE__ */ et(o) ? l : o;
        return s.has.call(r, c) || Ue(o, c) && s.has.call(r, o) || Ue(l, c) && s.has.call(r, l) || (r.add(c), Xe(r, "add", c, c)), this;
      },
      set(o, r) {
...
function ui(t, e) {
  const n = hs(t, e);
  return (i, o, r) => o === "__v_isReactive" ? !t : o === "__v_isReadonly" ? t : o === "__v_raw" ? i : Reflect.get(
    H(n, o) && o in i ? n : i,
    o,
    r
  );
...
function ks(t) {
  return !H(t, "__v_skip") && Object.isExtensible(t) && To(t, "__v_skip", !0), t;
}
...
function Ao(t) {
  return /* @__PURE__ */ ft(t) ? t : new Proxy(t, Ts);
}
class qs {
  constructor(e, n, i) {
    this.fn = e, this.setter = n, this._value = void 0, this.dep = new Ko(this), this.__v_isRef = !0, this.deps = void 0, this.depsTail = void 0, this.flags = 16, this.globalVersion = Zt - 1, this.next = void 0, this.effect = this, this.__v_isReadonly = !n, this.isSSR = i;
  }
  /**
   * @internal
   */
...
function Ns(t, e, n = !1) {
  let i, o;
  return F(t) ? i = t : (i = t.get, o = t.set), new qs(i, o, n);
}
...
function Ps(t, e, n = Y) {
  const { immediate: i, deep: o, once: r, scheduler: s, augmentJob: l, call: c } = n, a = (I) => o ? I : /* @__PURE__ */ Ee(I) || o === !1 || o === 0 ? $e(I, 1) : $e(I);
  let f, b, u, p, m = !1, g = !1;
  if (/* @__PURE__ */ ae(t) ? (b = () => t.value, m = /* @__PURE__ */ Ee(t)) : /* @__PURE__ */ ft(t) ? (b = () => a(t), m = !0) : D(t) ? (g = !0, m = t.some((I) => /* @__PURE__ */ ft(I) || /* @__PURE__ */ Ee(I)), b = () => t.map((I) => {
    if (/* @__PURE__ */ ae(I))
      return I.value;
    if (/* @__PURE__ */ ft(I))
      return a(I);
    ...
    const I = b, W = o === !0 ? 1 / 0 : o;
    b = () => $e(I(), W);
  }
  const N = ns(), T = () => {
    f.stop(), N && N.active && li(N.effects, f);
  };
  if (r && e) {
    const I = e;
    e = (...W) => {
  ...
  let V = g ? new Array(t.length).fill(en) : en;
  const M = (I) => {
    if (!(!(f.flags & 1) || !f.dirty && !I))
      if (e) {
        const W = f.run();
        if (o || m || (g ? W.some((Q, be) => Ue(Q, V[be])) : Ue(W, V))) {
          u && u();
          const Q = lt;
          lt = f;
          try {
  ...
  return l && l(M), f = new Io(b), f.scheduler = s ? () => s(M, !1) : M, p = (I) => Ss(I, !1, f), u = f.onStop = () => {
    const I = cn.get(f);
    if (I) {
      if (c)
        c(I, 4);
  ...
  }, e ? i ? M(!0) : V = f.run() : s ? s(M.bind(null, !0), !0) : f.run(), T.pause = f.pause.bind(f), T.resume = f.resume.bind(f), T.stop = T, T;
}
...
function mi(t) {
  if (!(t.flags & 1)) {
    ...
    !(t.flags & 2) && e >= Ht(n) ? ce.push(t) : ce.splice(zs(e), 0, t), t.flags |= 1, Xo();
  }
}
function Xo() {
  fn || (fn = Uo.then(Go));
...
function Os(t) {
  D(t) ? mt.push(...t) : _e && t.id === -1 ? _e.splice(dt + 1, 0, t) : t.flags & 1 || (mt.push(t), t.flags |= 1), Xo();
}
function Wi(t, e, n = Ve + 1) {
  for (; n < ce.length; n++) {
    const i = ce[n];
    if (i && i.flags & 2) {
      if (t && i.id !== t.uid)
...
function Go(t) {
  try {
    ...
    Ve = -1, ce.length = 0, Jo(), fn = null, (ce.length || mt.length) && Go();
  }
}
let De = null, Yo = null;
function an(t) {
  const e = De;
  return De = t, Yo = t && t.type.__scopeId || null, e;
}
function Cs(t, e = De, n) {
  if (!e || t._n)
    return t;
  const i = (...o) => {
    i._d && Yi(-1);
...
const js = /* @__PURE__ */ Symbol.for("v-scx"), Ks = () => on(js);
function Wn(t, e, n) {
  return Bo(t, e, n);
}
function Bo(t, e, n = Y) {
  ...
  r === "post" ? l.scheduler = (p) => {
    de(p, f && f.suspense);
  } : r !== "sync" && (b = !0, l.scheduler = (p, m) => {
    m ? p() : mi(p);
  }), l.augmentJob = (p) => {
    e && (p.flags |= 4), b && (p.flags |= 2, f && (p.id = f.uid, p.i = f));
  };
  const u = Ps(t, e, l);
  return At && (a ? a.push(u) : c && u()), u;
}
function Ds(t, e, n) {
  const i = this.proxy, o = ee(t) ? t.includes(".") ? Qo(i, t) : () => i[t] : t.bind(i, i);
  let r;
  F(e) ? r = e : (r = e.handler, n = e);
  const s = Gt(this), l = Bo(o, r.bind(i), n);
  return s(), l;
}
function Qo(t, e) {
  const n = e.split(".");
...
const Ws = /* @__PURE__ */ Symbol("_vte"), Fs = (t) => t.__isTeleport, Zs = /* @__PURE__ */ Symbol("_leaveCb");
function vi(t, e) {
...
function jt(t, e, n, i, o = !1) {
  ...
  const r = i.shapeFlag & 4 ? Ei(i.component) : i.el, s = o ? null : r, { i: l, r: c } = t, a = e && e.r, f = l.refs === Y ? l.refs = {} : l.refs, b = l.setupState, u = /* @__PURE__ */ L(b), p = b === Y ? vo : (g) => Fi(f, g) ? !1 : H(u, g), m = (g, N) => !(N && Fi(f, N));
  if (a != null && a !== c) {
    if (Zi(e), ee(a))
      f[a] = null, p(a) && (b[a] = null);
    else if (/* @__PURE__ */ ae(a)) {
      const g = e;
      m(a, g.k) && (a.value = null), g.k && (f[g.k] = null);
    }
  }
  if (F(c))
    Jt(c, l, 12, [s, f]);
  else {
    const g = ee(c), N = /* @__PURE__ */ ae(c);
    if (g || N) {
      const T = () => {
        if (t.f) {
          const V = g ? p(c) ? b[c] : f[c] : m() || !t.k ? c.value : f[t.k];
          if (o)
            D(V) && li(V, r);
          else if (D(V))
            ...
            const M = [r];
            m(c, t.k) && (c.value = M), t.k && (f[t.k] = M);
          }
        } else g ? (f[c] = s, p(c) && (b[c] = s)) : N && (m(c, t.k) && (c.value = s), t.k && (f[t.k] = s));
      };
      if (s) {
        const V = () => {
          T(), bn.delete(t);
        };
        V.id = -1, bn.set(t, V), de(V, n);
      } else
        Zi(t), T();
    }
  }
...
const Kt = (t) => !!t.type.__asyncLoader, $o = (t) => t.type.__isKeepAlive;
function Rs(t, e) {
  er(t, "a", e);
}
function Hs(t, e) {
...
function qn(t, e, n = fe, i = !1) {
  if (n) {
    const o = n[t] || (n[t] = []), r = e.__weh || (e.__weh = (...s) => {
      Ge();
      const l = Gt(n), c = Ze(e, n, t, s);
      return l(), Ye(), c;
    });
...
const Qn = (t) => t ? Er(t) ? Ei(t) : Qn(t.parent) : null, Dt = (
  ...
  /* @__PURE__ */ re(/* @__PURE__ */ Object.create(null), {
    ...
    $nextTick: (t) => t.n || (t.n = Vs.bind(t.proxy)),
    $watch: (t) => Ds.bind(t)
  })
  ...
  get({ _: t }, e) {
    if (e === "__v_skip")
      return !0;
    const { ctx: n, setupState: i, data: o, props: r, accessCache: s, type: l, appContext: c } = t;
    if (e[0] !== "$") {
      const u = s[e];
      if (u !== void 0)
        switch (u) {
  ...
  has({
    ...
    let c;
    return !!(n[l] || t !== Y && l[0] !== "$" && H(t, l) || Fn(e, l) || H(r, l) || H(i, l) || H(Dt, l) || H(o.config.globalProperties, l) || (c = s.__cssModules) && c[l]);
  },
...
function nl(t) {
  ...
  if (_n = !0, r)
    for (const B in r) {
      const X = r[B], it = F(X) ? X.bind(n, n) : F(X.get) ? X.get.bind(n, n) : We, Bt = !F(X) && F(X.set) ? X.set.bind(n) : We, ot = Rl({
        get: it,
        set: Bt
      });
  ...
  f && Hi(f, t, "c");
  function se(B, X) {
    D(X) ? X.forEach((it) => B(it.bind(n))) : X && B(X.bind(n));
  }
  if (se(As, b), se(Us, u), se(Xs, p), se(Js, m), se(Rs, g), se(Hs, N), se(_s, Te), se(Qs, Q), se(Bs, be), se(Gs, V), se(tr, I), se(Ys, Re), D(Z))
    if (Z.length) {
  ...
  W && t.render === We && (t.render = W), ne != null && (t.inheritAttrs = ne), ye && (t.components = ye), nt && (t.directives = nt), Re && _o(t);
}
function il(t, e, n = We) {
  D(t) && (t = $n(t));
  for (const i in t) {
    const o = t[i];
    let r;
    A(o) ? "default" in o ? r = on(
      o.from || i,
      o.default,
      !0
    ) : r = on(o.from || i) : r = on(o), /* @__PURE__ */ ae(r) ? Object.defineProperty(e, i, {
      enumerable: !0,
      configurable: !0,
      get: () => r.value,
      set: (s) => r.value = s
...
function Hi(t, e, n) {
  Ze(
    D(t) ? t.map((i) => i.bind(e.proxy)) : t.bind(e.proxy),
    e,
    n
  );
}
...
function Ai(t, e) {
  return t ? D(t) && D(e) ? [.../* @__PURE__ */ new Set([...t, ...e])] : re(
...
function cl(t, e) {
  return function(i, o = null) {
    ...
    const r = or(), s = /* @__PURE__ */ new WeakSet(), l = [];
    let c = !1;
    const a = r.app = {
      _uid: ll++,
      _component: i,
      ...
      use(f, ...b) {
        return s.has(f) || (f && F(f.install) ? (s.add(f), f.install(a, ...b)) : F(f) && (s.add(f), f(a, ...b))), a;
      },
      mixin(f) {
      ...
      mount(f, b, u) {
        if (!c) {
          const p = a._ceVNode || Je(i, o);
          return p.appContext = r, u === !0 ? u = "svg" : u === !1 && (u = void 0), t(p, f, u), c = !0, a._container = f, f.__vue_app__ = a, Ei(p.component);
        }
      },
      onUnmount(f) {
        l.push(f);
...
function al(t, e, ...n) {
  ...
  let o = n;
  const r = e.startsWith("update:"), s = r && fl(i, e.slice(7));
  s && (s.trim && (o = n.map((f) => ee(f) ? f.trim() : f)), s.number && (o = n.map(Jr)));
  let l, c = i[l = On(e)] || // also try camelCase event handler (#2249)
  i[l = On(we(e))];
  !c && r && (c = i[l = On(at(e))]), c && Ze(
    c,
    t,
    6,
    o
...
function rr(t, e, n = !1) {
  ...
  return !r && !l ? (A(t) && i.set(t, null), null) : (D(r) ? r.forEach((c) => s[c] = null) : re(s, r), A(t) && i.set(t, s), s);
}
function Nn(t, e) {
...
function Ui(t) {
  ...
  try {
    ...
    Wt.length = 0, Tn(I, t, 1), T = Je(tt);
  }
  let M = T;
  if (V && g !== !1) {
    const I = Object.keys(V), { shapeFlag: W } = M;
    I.length && W & 7 && (r && I.some(vn) && (V = ul(
      V,
      r
    )), M = xt(M, V, !1, !0));
  }
  return n.dirs && (M = xt(M, null, !1, !0), M.dirs = M.dirs ? M.dirs.concat(n.dirs) : n.dirs), n.transition && vi(M, n.transition), T = M, an(N), T;
}
const dl = (t) => {
  let e;
  for (const n in t)
...
function hl(t, e, n) {
  ...
  if (n && c >= 0) {
    ...
    return (o || l) && (!l || !l.$stable) ? !0 : i === s ? !1 : i ? s ? Xi(i, s, a) : !0 : !!s;
  return !1;
}
function Xi(t, e, n) {
...
function gl(t, e, n, i = !1) {
  const o = {}, r = cr();
  t.propsDefaults = /* @__PURE__ */ Object.create(null), ar(t, e, o, r);
  for (const s in t.propsOptions[0])
    s in o || (o[s] = void 0);
  n ? t.props = i ? o : /* @__PURE__ */ ws(o) : t.type.props ? t.props = o : t.props = r, t.attrs = r;
}
function ml(t, e, n, i) {
  const {
    props: o,
...
function br(t, e, n = !1) {
  ...
  if (D(r))
    ...
    for (const f in r) {
      const b = we(f);
      if (Ji(b)) {
        const u = r[f], p = s[b] = D(u) || F(u) ? { type: u } : re({}, u), m = p.type;
        let g = !1, N = !0;
        if (D(m))
          for (let T = 0; T < m.length; ++T) {
            const V = m[T], M = F(V) && V.name;
            if (M === "Boolean") {
              g = !0;
              break;
            } else M === "String" && (N = !1);
...
const yi = (t) => t === "_" || t === "_ctx" || t === "$stable", xi = (t) => D(t) ? t.map(Me) : [Me(t)], yl = (t, e, n) => {
  if (e._n)
    return e;
  const i = Cs((...o) => xi(e(...o)), n);
  return i._c = !1, i;
}, dr = (t, e, n) => {
  const i = t._ctx;
  for (const o in t) {
  ...
  if (t.vnode.shapeFlag & 32) {
    const o = e._;
    o ? (hr(i, e, n), n && To(i, "_", o, !0)) : dr(e, i);
  } else e && ur(t, e);
}, wl = (t, e, n) => {
  ...
  if (i.shapeFlag & 32) {
    const l = e._;
    l ? n && l === 1 ? r = !1 : hr(o, e, n) : (r = !e.$stable, dr(e, o)), s = e;
  } else e && (ur(t, e), s = { default: 1 });
  if (r)
    for (const l in o)
      !yi(l) && s[l] == null && delete o[l];
}, de = Nl;
function kl(t) {
  return El(t);
}
function El(t, e) {
  ...
  const {
  ...
  } = t, g = (d, h, v, k = null, y = null, x = null, S = void 0, q = null, E = !!h.dynamicChildren) => {
    if (d === h)
      return;
    d && !It(d, h) && (k = Qt(d), qe(d, y, x, !0), d = null), h.patchFlag === -2 && (E = !1, h.dynamicChildren = null);
    const { type: w, ref: C, shapeFlag: P } = h;
    switch (w) {
      case Sn:
        N(d, h, v, k);
        break;
    ...
    C != null && y ? jt(C, d && d.ref, x, h || d, !h) : C == null && d && d.ref != null && jt(d.ref, null, x, d, !0);
  }, N = (d, h, v, k) => {
    if (d == null)
      i(
        h.el = l(h.children),
    ...
    let E, w;
    const { props: C, shapeFlag: P, transition: O, dirs: j } = d;
    if (E = d.el = s(
      d.type,
      x,
      C && C.is,
      C
    ), P & 8 ? f(E, d.children) : P & 16 && Te(
      d.children,
      E,
      null,
      k,
      ...
      S,
      q
    ), j && rt(d, null, k, "created"), be(E, d, d.scopeId, S, k), C) {
      for (const U in C)
        U !== "value" && !Ot(U) && r(E, U, null, C[U], x, k);
      "value" in C && r(E, "value", null, C.value, x), (w = C.onVnodeBeforeMount) && Ie(w, k, d);
    }
    j && rt(d, null, k, "beforeMount");
    const R = Tl(y, O);
    R && O.beforeEnter(E), i(E, h, v), ((w = C && C.onVnodeMounted) || R || j) && de(() => {
      try {
        w && Ie(w, k, d), R && O.enter(E), j && rt(d, null, k, "mounted");
      } finally {
      }
    }, y);
  }, be = (d, h, v, k, y) => {
    ...
    if (y) {
      let x = y.subTree;
      if (h === x || vr(x.type) && (x.ssContent === h || x.ssFallback === h)) {
        const S = y.vnode;
        be(
          d,
          S,
  ...
  }, Te = (d, h, v, k, y, x, S, q, E = 0) => {
    for (let w = E; w < d.length; w++) {
      const C = d[w] = q ? Ae(d[w]) : Me(d[w]);
      g(
        null,
        C,
        h,
    ...
    const q = h.el = d.el;
    let { patchFlag: E, dynamicChildren: w, dirs: C } = h;
    E |= d.patchFlag & 16;
    const P = d.props || Y, O = h.props || Y;
    let j;
    if (v && st(v, !1), (j = O.onVnodeBeforeUpdate) && Ie(j, v, h, d), C && rt(h, d, v, "beforeUpdate"), v && st(v, !0), (P.innerHTML && O.innerHTML == null || P.textContent && O.textContent == null) && f(q, ""), w ? Z(
      d.dynamicChildren,
      w,
      q,
      v,
      ...
      if (E & 16)
        ne(q, P, O, v, y);
      else if (E & 2 && P.class !== O.class && r(q, "class", null, O.class, y), E & 4 && r(q, "style", P.style, O.style, y), E & 8) {
        const R = h.dynamicProps;
        for (let U = 0; U < R.length; U++) {
          const J = R[U], $ = P[J], ie = O[J];
          (ie !== $ || J === "value") && r(q, J, $, ie, y, v);
        }
      }
      E & 1 && d.children !== h.children && f(q, h.children);
    } else !S && w == null && ne(q, P, O, v, y);
    ((j = O.onVnodeUpdated) || C) && de(() => {
      j && Ie(j, v, h, d), C && rt(h, d, v, "updated");
    }, k);
  }, Z = (d, h, v, k, y, x, S) => {
    ...
    if (h !== v) {
      ...
      for (const x in v) {
        if (Ot(x)) continue;
        const S = v[x], q = h[x];
        S !== q && x !== "value" && r(d, x, q, S, y, k);
      }
      "value" in v && r(d, "value", h.value, v.value, y);
    }
  }, ye = (d, h, v, k, y, x, S, q, E) => {
    const w = h.el = d ? d.el : l(""), C = h.anchor = d ? d.anchor : l("");
    let { patchFlag: P, dynamicChildren: O, slotScopeIds: j } = h;
    j && (q = q ? q.concat(j) : j), d == null ? (i(w, v, k), i(C, v, k), Te(
      // #10007
    ...
    d.dynamicChildren && d.dynamicChildren.length === O.length ? (Z(
      d.dynamicChildren,
      O,
      v,
      y,
  ...
  }, nt = (d, h, v, k, y, x, S, q, E) => {
    h.slotScopeIds = q, d == null ? h.shapeFlag & 512 ? y.ctx.activate(
      h,
      v,
      k,
      S,
    ...
    const q = d.component = Ml(
      d,
      k,
      y
    );
    if ($o(d) && (q.ctx.renderer = qt), Kl(q, !1, S), q.asyncDep) {
      if (y && y.registerDep(q, se, S), !d.el) {
        const E = q.subTree = Je(tt);
        T(null, E, h, v), d.placeholder = E.el;
      }
    } else
      se(
        q,
    ...
    const q = () => {
      if (d.isMounted) {
        let { next: P, bu: O, u: j, parent: R, vnode: U } = d;
        {
          const Se = gr(d);
          if (Se) {
            P && (P.el = U.el, B(d, P, S)), Se.asyncDep.then(() => {
              de(() => {
                d.isUnmounted || w();
              }, y);
            });
        ...
        let J = P, $;
        st(d, !1), P ? (P.el = U.el, B(d, P, S)) : P = U, O && Cn(O), ($ = P.props && P.props.onVnodeBeforeUpdate) && Ie($, R, P, U), st(d, !0);
        ...
        d.subTree = ie, g(
          ...
          y,
          x
        ), P.el = ie.el, J === null && pl(d, ie.el), j && de(j, y), ($ = P.props && P.props.onVnodeUpdated) && de(
          () => Ie($, R, P, U),
          y
        );
      } else {
        let P;
        const { el: O, props: j } = h, { bm: R, m: U, parent: J, root: $, type: ie } = d, Ne = Kt(h);
        st(d, !1), R && Cn(R), !Ne && (P = j && j.onVnodeBeforeMount) && Ie(P, J, h), st(d, !0);
        {
        ...
        if (U && de(U, y), !Ne && (P = j && j.onVnodeMounted)) {
          const Se = h;
          de(
            () => Ie(P, J, Se),
            y
        ...
        (h.shapeFlag & 256 || J && Kt(J.vnode) && J.vnode.shapeFlag & 256) && d.a && de(d.a, y), d.isMounted = !0, h = v = k = null;
      }
    };
    d.scope.on();
    const E = d.effect = new Io(q);
    d.scope.off();
    const w = d.update = E.run.bind(E), C = d.job = E.runIfDirty.bind(E);
    C.i = d, C.id = d.uid, E.scheduler = () => mi(C), st(d, !0), w();
  }, B = (d, h, v) => {
    h.component = d;
    const k = d.vnode.props;
    d.vnode = h, d.next = null, ml(d, h.props, k, v), wl(d, h.children, v), Ge(), Wi(d), Ye();
  }, X = (d, h, v, k, y, x, S, q, E = !1) => {
    const w = d && d.children, C = d ? d.shapeFlag : 0, P = h.children, { patchFlag: O, shapeFlag: j } = h;
    if (O > 0) {
      if (O & 128) {
        Bt(
          w,
    ...
    j & 8 ? (C & 16 && Tt(w, y, x), P !== w && f(v, P)) : C & 16 ? j & 16 ? Bt(
      w,
      P,
      v,
      k,
  ...
  }, it = (d, h, v, k, y, x, S, q, E) => {
    d = d || pt, h = h || pt;
    const w = d.length, C = h.length, P = Math.min(w, C);
    let O;
    for (O = 0; O < P; O++) {
      const j = h[O] = E ? Ae(h[O]) : Me(h[O]);
      g(
        d[O],
        j,
        v,
  ...
  }, Bt = (d, h, v, k, y, x, S, q, E) => {
    let w = 0;
    const C = h.length;
    let P = d.length - 1, O = C - 1;
    for (; w <= P && w <= O; ) {
      const j = d[w], R = h[w] = E ? Ae(h[w]) : Me(h[w]);
      if (It(j, R))
        g(
          j,
          R,
    ...
    for (; w <= P && w <= O; ) {
      const j = d[P], R = h[O] = E ? Ae(h[O]) : Me(h[O]);
      if (It(j, R))
        g(
          j,
          R,
    ...
    if (w > P) {
      ...
      const j = w, R = w, U = /* @__PURE__ */ new Map();
      for (w = R; w <= O; w++) {
        const pe = h[w] = E ? Ae(h[w]) : Me(h[w]);
      ...
      for (w = j; w <= P; w++) {
        ...
        if (pe.key != null)
          ...
          for (J = R; J <= O; J++)
            if (Nt[J - R] === 0 && It(pe, h[J])) {
              Pe = J;
              break;
            }
        Pe === void 0 ? qe(pe, y, x, !0) : (Nt[Pe - R] = w + 1, Pe >= Se ? Se = Pe : Ne = !0, g(
          pe,
          h[Pe],
          v,
          null,
      ...
      const zi = Ne ? ql(Nt) : pt;
      for (J = zi.length - 1, w = ie - 1; w >= 0; w--) {
        const pe = R + w, Pe = h[pe], Oi = h[pe + 1], Ci = pe + 1 < C ? (
        ...
        Nt[w] === 0 ? g(
          ...
          q,
          E
        ) : Ne && (J < 0 || w !== zi[J] ? ot(Pe, v, Ci, 2) : J--);
      }
    }
  }, ot = (d, h, v, k, y = null) => {
    const { el: x, type: S, transition: q, children: E, shapeFlag: w } = d;
    if (w & 6) {
      ot(d.component.subTree, h, v, k);
      return;
    }
    if (w & 128) {
      d.suspense.move(h, v, k);
      return;
    }
    if (w & 64) {
      S.move(d, h, v, qt);
    ...
    if (k !== 2 && w & 1 && q)
      if (k === 0)
        q.beforeEnter(x), i(x, h, v), de(() => q.enter(x), y);
      else {
        const { leave: P, delayLeave: O, afterLeave: j } = q, R = () => {
          d.ctx.isUnmounted ? o(x) : i(x, h, v);
        }, U = () => {
          x._isLeaving && x[Zs](
            !0
            /* cancelled */
    ...
    if (P === -2 && (y = !1), q != null && (Ge(), jt(q, null, v, d, !0), Ye()), j != null && (h.renderCache[j] = void 0), C & 256) {
      h.ctx.deactivate(d);
      return;
    }
    const U = C & 1 && O, J = !Kt(d);
    let $;
    if (J && ($ = S && S.onVnodeBeforeUnmount) && Ie($, h, d), C & 6)
      Hr(d.component, v, k);
    else {
      if (C & 128) {
      ...
      U && rt(d, null, h, "beforeUnmount"), C & 64 ? d.type.remove(
        d,
        h,
        v,
        qt,
      ...
      (x !== Ce || P > 0 && P & 64) ? Tt(
        ...
        !1,
        !0
      ) : (x === Ce && P & 384 || !y && C & 16) && Tt(E, h, v), k && Ii(d);
    }
    const ie = R != null && j == null;
    (J && ($ = S && S.onVnodeUnmounted) || U || ie) && de(() => {
      $ && Ie($, h, d), U && rt(d, null, h, "unmounted"), ie && (d.el = null);
    }, v);
  }, Ii = (d) => {
    const { type: h, el: v, anchor: k, transition: y } = d;
    if (h === Ce) {
      Rr(v, k);
      return;
    }
    ...
    if (d.shapeFlag & 1 && y && !y.persisted) {
      const { leave: S, delayLeave: q } = y, E = () => S(v, x);
      q ? q(d.el, x, E) : E();
    } else
      x();
  }, Rr = (d, h) => {
    ...
    const { bum: k, scope: y, job: x, subTree: S, um: q, m: E, a: w } = d;
    Gi(E), Gi(w), k && Cn(k), y.stop(), x && (x.flags |= 8, qe(S, d, h, v)), q && de(q, h), de(() => {
      d.isUnmounted = !0;
    }, h);
  }, Tt = (d, h, v, k = !1, y = !1, x = 0) => {
    ...
    const h = u(d.anchor || d.el), v = h && h[Ws];
    return v ? u(v) : h;
  };
  let zn = !1;
  const Vi = (d, h, v) => {
    let k;
    d == null ? h._vnode && (qe(h._vnode, null, null, !0), k = h._vnode.component) : g(
      h._vnode || null,
      d,
      h,
      null,
      ...
      null,
      v
    ), h._vnode = d, zn || (zn = !0, Wi(k), Jo(), zn = !1);
  }, qt = {
    p: g,
    um: qe,
    m: ot,
...
function pr(t, e, n = !1) {
  ...
  if (D(i) && D(o))
    for (let r = 0; r < i.length; r++) {
      const s = i[r];
      let l = o[r];
      l.shapeFlag & 1 && !l.dynamicChildren && ((l.patchFlag <= 0 || l.patchFlag === 32) && (l = o[r] = Ae(o[r]), l.el = s.el), !n && l.patchFlag !== -2 && pr(s, l)), l.type === Sn && (l.patchFlag === -1 && (l = o[r] = Ae(l)), l.el = s.el), l.type === tt && !l.el && (l.el = s.el);
    }
}
function ql(t) {
  const e = t.slice(), n = [0];
...
function Nl(t, e) {
  e && e.pendingBranch ? D(t) ? e.effects.push(...t) : e.effects.push(t) : Os(t);
}
const Ce = /* @__PURE__ */ Symbol.for("v-fgt"), Sn = /* @__PURE__ */ Symbol.for("v-txt"), tt = /* @__PURE__ */ Symbol.for("v-cmt"), Rn = /* @__PURE__ */ Symbol.for("v-stc"), Wt = [];
let ve = null;
function ut(t = !1) {
  Wt.push(ve = t ? null : []);
}
...
const wr = ({ key: t }) => t ?? null, rn = ({
  ...
  ref_key: e,
  ref_for: n
}) => (typeof t == "number" && (t = "" + t), t != null ? ee(t) || /* @__PURE__ */ ae(t) || F(t) ? { i: De, r: t, k: e, f: !!n } : t : null);
function wi(t, e = null, n = null, i = 0, o = null, r = t === Ce ? 0 : 1, s = !1, l = !1) {
  const c = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: t,
  ...
  return l ? (ki(c, n), r & 128 && t.normalize(c)) : n && (c.shapeFlag |= ee(n) ? 8 : 16), Lt > 0 && // avoid a block node from tracking itself
...
const Je = Il;
function Il(t, e = null, n = null, i = 0, o = null, r = !1) {
  if ((!t || t === $s) && (t = tt), xr(t)) {
    const l = xt(
      t,
      e,
    ...
    return n && ki(l, n), Lt > 0 && !r && ve && (l.shapeFlag & 6 ? ve[ve.indexOf(t)] = l : ve.push(l)), l.patchFlag = -2, l;
  }
  if (Zl(t) && (t = t.__vccOpts), e) {
    e = Vl(e);
    let { class: l, style: c } = e;
    l && !ee(l) && (e.class = kn(l)), A(c) && (/* @__PURE__ */ gi(c) && !D(c) && (c = re({}, c)), e.style = wn(c));
  }
  const s = ee(t) ? 1 : vr(t) ? 128 : Fs(t) ? 64 : A(t) ? 4 : F(t) ? 2 : 0;
  return wi(
    t,
    e,
    n,
...
function xt(t, e, n = !1, i = !1) {
  const { props: o, ref: r, patchFlag: s, children: l, transition: c } = t, a = e ? zl(o || {}, e) : o, f = {
    ...
    ref: e && e.ref ? (
      ...
      n && r ? D(r) ? r.concat(rn(e)) : [r, rn(e)] : rn(e)
    ) : r,
    scopeId: t.scopeId,
...
function Me(t) {
  return t == null || typeof t == "boolean" ? Je(tt) : D(t) ? Je(
    Ce,
    null,
...
function ki(t, e) {
  ...
  if (e == null)
    ...
    if (i & 65) {
      ...
      n = 32;
      const o = e._;
      !o && !fr(e) ? e._ctx = De : o === 3 && De && (De.slots._ === 1 ? e._ = 1 : (e._ = 2, t.patchFlag |= 1024));
    }
  else F(e) ? (e = { default: e, _ctx: De }, n = 32) : (e = String(e), i & 64 ? (n = 16, e = [kr(e)]) : n = 8);
  ...
  for (let n = 0; n < t.length; n++) {
    ...
    for (const o in i)
      if (o === "class")
        ...
        const r = e[o], s = i[o];
        s && r !== s && !(D(r) && r.includes(s)) ? e[o] = r ? [].concat(r, s) : s : s == null && r == null && // mergeProps({ 'onUpdate:modelValue': undefined }) should not retain
        // the model listener.
        !vn(o) && (e[o] = s);
      } else o !== "" && (e[o] = i[o]);
  }
...
let Cl = 0;
function Ml(t, e, n) {
  const i = t.type, o = (e ? e.appContext : t.appContext) || Ol, r = {
    uid: Cl++,
    vnode: t,
    type: i,
    parent: e,
  ...
  return r.ctx = { _: r }, r.root = e ? e.root : r, r.emit = al.bind(null, r), t.ce && t.ce(r), r;
}
let fe = null;
const jl = () => fe || De;
let un, ti;
...
function Kl(t, e = !1, n = !1) {
  e && ti(e);
  const { props: i, children: o } = t.vnode, r = Er(t);
  gl(t, i, r, e), xl(t, o, n || e);
  const s = r ? Dl(t, e) : void 0;
  return e && ti(!1), s;
}
function Dl(t, e) {
  const n = t.type;
  ...
  if (i) {
    Ge();
    const o = t.setupContext = i.length > 1 ? Fl(t) : null, r = Gt(t), s = Jt(
      i,
      t,
      0,
      [
...
function _i(t, e, n) {
  F(e) ? t.type.__ssrInlineRender ? t.ssrRender = e : t.render = e : A(e) && (t.setupState = Ao(e)), Tr(t);
}
function Tr(t, e, n) {
  const i = t.type;
  t.render || (t.render = i.render || We);
  {
    const o = Gt(t);
    Ge();
    try {
...
const qr = ni ? (t) => ni.createHTML(t) : (t) => t, Ll = "http://www.w3.org/2000/svg", Al = "http://www.w3.org/1998/Math/MathML", Le = typeof document < "u" ? document : null, eo = Le && /* @__PURE__ */ Le.createElement("template"), Ul = {
  insert: (t, e, n) => {
    ...
    if (e)
      if (ee(e))
        ...
        for (const s in e)
          n[s] == null && sn(i, s, "");
    for (const s in n)
      s === "display" && (r = !0), sn(i, s, n[s]);
  } else if (o) {
    if (e !== n) {
      const s = i[Yl];
      s && (n += ";" + s), i.cssText = n, r = Bl.test(n);
    }
  } else e && t.removeAttribute("style");
  to in t && (t[to] = r ? i.display : "", t[Gl] && (i.display = "none"));
}
...
function ro(t, e, n, i, o, r = $r(e)) {
  i && e.startsWith("xlink:") ? n == null ? t.removeAttributeNS(oo, e.slice(6, e.length)) : t.setAttributeNS(oo, e, n) : n == null || r && !qo(n) ? t.removeAttribute(e) : t.setAttribute(
    e,
    r ? "" : Fe(n) ? String(n) : n
  );
}
function so(t, e, n, i, o) {
  ...
  if (n === "" || n == null) {
    const l = typeof t[e];
    l === "boolean" ? n = qo(n) : n == null && l === "string" ? (n = "", s = !0) : l === "number" && (n = 0, s = !0);
  }
  try {
    t[e] = n;
  } catch {
...
t.charCodeAt(2) > 96 && t.charCodeAt(2) < 123, lc = (t, e, n, i, o, r) => {
  const s = o === "svg";
  e === "class" ? Jl(t, i, s) : e === "style" ? Ql(t, n, i) : mn(e) ? vn(e) || tc(t, e, n, i, r) : (e[0] === "." ? (e = e.slice(1), !0) : e[0] === "^" ? (e = e.slice(1), !1) : cc(t, e, i, s)) ? (so(t, e, i), !t.tagName.includes("-") && (e === "value" || e === "checked" || e === "selected") && ro(t, e, i, s, r, e !== "value")) : /* #11081 force set props for possible async custom element */ t._isVueCE && // #12408 check if it's declared prop or it's async custom element
  (fc(t, e) || // @ts-expect-error _def is private
  t._def.__asyncLoader && (/[A-Z]/.test(e) || !ee(i))) ? so(t, we(e), i, r, e) : (e === "true-value" ? t._trueValue = i : e === "false-value" && (t._falseValue = i), ro(t, e, i, s));
};
function cc(t, e, n, i) {
  if (i)
    return !!(e === "innerHTML" || e === "textContent" || e in t && fo(e) && F(n));
...
function Pn(t, e = 0, n = {}) {
  let i, o, r, s, l, c, a = 0, f = !1, b = !1, u = !0;
  const p = !e && e !== 0 && typeof tn.requestAnimationFrame == "function";
  if (typeof t != "function")
    throw new TypeError("Expected a function");
  e = +e || 0, Nr(n) && (f = !!n.leading, b = "maxWait" in n, r = b ? Math.max(+n.maxWait || 0, e) : r, u = "trailing" in n ? !!n.trailing : u);
  function m(Z) {
    const ne = i, ye = o;
  ...
  function W(Z) {
    return l = void 0, u && i ? m(Z) : (i = o = void 0, s);
  }
  function Q() {
    l !== void 0 && N(l), a = 0, i = c = o = l = void 0;
  }
  function be() {
    return l === void 0 ? s : W(Date.now());
  }
  function Te() {
    return l !== void 0;
  }
  function Re(...Z) {
    const ne = Date.now(), ye = M(ne);
    ...
    return l === void 0 && (l = g(I, e)), s;
  }
  return Re.cancel = Q, Re.flush = be, Re.pending = Te, Re;
}
function Sr(t, e = 0, n = {}) {
  let i = !0, o = !0;
  if (typeof t != "function")
...
const Pr = {
  ...
  4: "back",
  5: "forward"
}, wc = 9007199254740991, kc = Nc(), Ti = kc.isMac, Ec = /[&<>"'/]/g, Tc = /[<>"'/]/g, Ir = {
  "&": "&amp;",
  "<": "&lt;",
  ">": "&gt;",
  '"': "&quot;",
...
function qi(t, e = !1) {
  ...
  if (n === "SPAN" && t.classList.contains("wb-col")) {
    const o = t, r = o.querySelector("input,select");
    if (r)
      return qi(r, e);
    o.innerText = "" + i;
  } else if (n === "INPUT") {
    ...
    switch (o.type) {
      ...
      case "radio":
        {
          const s = o.name, l = o.parentElement.querySelector(`input[name="${s}"]:checked`);
          i = l ? l.value : void 0;
        }
        break;
      case "text":
...
const Vc = /* @__PURE__ */ new Set(["Alt", "Control", "Meta", "Shift"]);
function kt(t) {
  return t ? typeof t == "string" ? document.querySelector(t) : t : null;
}
function Ut(t) {
  const e = t.key, n = t.type, i = [];
  return t.altKey && i.push("Alt"), t.ctrlKey && i.push("Control"), t.metaKey && i.push("Meta"), t.shiftKey && i.push("Shift"), n === "click" || n === "dblclick" ? i.push(Pr[t.button] + n) : n === "wheel" ? i.push(n) : Vc.has(e) || i.push(e), i.join("+");
}
function xe(...t) {
...
function Dr(t, e) {
  ...
  const c = (...a) => {
    if (r)
      ...
      const u = Date.now() - b, p = Math.min(Math.max(i, u * n.delayFactor), o), m = Math.max(i, p - u);
      l = setTimeout(() => {
  ...
  return c.cancel = () => {
    l && (clearTimeout(l), l = null), s = null, r = 0;
  }, c.pending = () => !!l, c.flush = () => {
 ...
 * v0.11.1, Fri, 27 Dec 2024 22:58:06 GMT (https://github.com/mar10/wunderbaum)
 */
const Ni = "￷", Si = "￸", Dc = new RegExp(wt(Ni), "g"), Wc = new RegExp(wt(Si), "g");
class Fc extends Et {
  constructor(e) {
    super(e, "filter", {
      autoApply: !0,
  ...
  _applyFilterImpl(e, n) {
    ...
    if (typeof e == "string" || e instanceof RegExp) {
      ...
      if (c.fuzzy) {
        ...
        const m = e.split("").map(wt).reduce(function(g, N) {
          return g + "([^" + N + "]*)" + N;
        }, "");
        u = new RegExp(m, "i");
        ...
        const m = wt(e);
        u = new RegExp(m, "i"), p = new RegExp(m, "gi");
      }
      r.logDebug(`Filtering nodes by '${u}'`), e = (m) => {
        if (!m.title)
          return !1;
        const g = m.title, N = u.exec(g);
        if (N && c.highlight) {
          let T;
          c.fuzzy ? T = Zc(g, N, !0) : T = g.replace(p, function(V) {
            return Ni + V + Si;
          }), m.titleWithHighlight = Yt(T).replace(Dc, "<mark>").replace(Wc, "</mark>");
        }
        return !!N;
      };
    }
    return r.filterMode = c.mode, this.lastFilterArgs = arguments, r.element.classList.toggle("wb-ext-filter-hide", !!a), r.element.classList.toggle("wb-ext-filter-dim", !a), r.element.classList.toggle("wb-ext-filter-hide-expanders", !!c.hideExpanders), r.root.subMatchCount = 0, r.visit((m) => {
      ...
      let g = e(m);
      if (g === "skip")
        return m.visit(function(T) {
          T.match = !1;
        }, !0), "skip";
      let N = !1;
      (f || g === "branch") && m.parent.match && (g = !0, N = !0), g && (i++, m.match = !0, m.visitParents((T) => {
        T !== m && (T.subMatchCount += 1), c.autoExpand && !N && !T.expanded && (T.setExpanded(!0, {
          noAnimation: !0,
          noEvents: !0
...
function Zc(t, e, n = !0) {
  ...
  for (let r = 1; r < e.length; r++) {
    const s = (
      ...
      e[r].length + (r === 1 ? 0 : 1) + (i[i.length - 1] || 0)
    );
    i.push(s);
  }
  const o = t.split("");
  return n ? i.forEach(function(r) {
    o[r] = Ni + o[r] + Si;
...
class Hc extends Et {
  ...
  onKeyEvent(e) {
    ...
    if (!b) {
      ...
      a = m || g, a && (a.setFocus(), b = i.getFocusNode(), b.logInfo("Keydown: force focus on active node."));
    }
    const p = b.isColspan();
    if (i.isRowNav()) {
      if (l) {
      ...
      switch (f === "Tab" ? (f = "ArrowRight", u = !0) : f === "Shift+Tab" && (f = i.activeColIdx > 0 ? "ArrowLeft" : "", u = !0), f) {
        case "+":
        case "Add":
          b.setExpanded(!0);
          break;
        ...
        case "Subtract":
          ...
          break;
        case " ":
          i.activeColIdx === 0 && b.getOption("checkbox") ? (b.toggleSelected(), u = !0) : s && m === "checkbox" && (s.click(), u = !0);
          break;
        case "F2":
          s && !l && g && (s.focus(), u = !0);
          break;
        case "Enter":
          i.setFocus(), (i.activeColIdx === 0 || p) && b.isExpandable() ? (b.setExpanded(!b.isExpanded()), u = !0) : s && !l && g && (s.focus(), u = !0);
          break;
        case "Escape":
          i.setFocus(), b.log("keynav: focus tree..."), i.isCellNav() && c !== he.cell && (b.log("keynav: setCellNav(false)"), i.setCellNav(!1), i.setFocus(), u = !0);
          break;
        case "ArrowLeft":
          i.setFocus(), p && b.isExpanded() ? b.setExpanded(!1) : !p && i.activeColIdx > 0 ? i.setColumn(i.activeColIdx - 1) : c !== he.cell && i.setCellNav(!1), u = !0;
          break;
        case "ArrowRight":
          i.setFocus(), p && !b.isExpanded() ? b.setExpanded() : !p && i.activeColIdx < i.columns.length - 1 && i.setColumn(i.activeColIdx + 1), u = !0;
          break;
        case "Home":
          i.setFocus(), !p && i.activeColIdx > 0 && i.setColumn(0), u = !0;
          break;
        case "End":
          i.setFocus(), !p && i.activeColIdx < i.columns.length - 1 && i.setColumn(i.columns.length - 1), u = !0;
          break;
        case "ArrowDown":
        case "ArrowUp":
        case "Backspace":
        ...
        case "PageDown":
        case "PageUp":
          b.navigate(f, { activate: r, event: n }), u = !0;
          break;
        default:
          u = !1;
      }
...
class Lc extends Et {
  ...
  init() {
    ...
    if (e.getOption("debugLevel") >= 4) {
      ...
      Mr(e, "callEvent", function(o, r) {
        if (n.has(o))
          return e._superApply(arguments);
        const s = Date.now(), l = e._superApply(arguments);
        return e.logDebug(`${i}: callEvent('${o}') took ${Date.now() - s} ms.`, arguments[1]), l;
      });
    }
  }
  onKeyEvent(e) {
...
class Ac extends Et {
  ...
  _guessDropEffect(e) {
    var n;
    const i = this.treeOpts.dnd, o = (n = i.effectAllowed) !== null && n !== void 0 ? n : "all", r = ["all", "copy", "copyLink", "copyMove"].includes(o), s = ["all", "link", "copyLink", "linkMove"].includes(o), l = ["all", "move", "copyMove", "linkMove"].includes(o);
    let c = i.dropEffectDefault;
    return i.guessDropEffect && (Ti ? (e.altKey && r && (c = "copy"), e.metaKey && l && (c = "move"), e.altKey && e.metaKey && s && (c = "link")) : (e.ctrlKey && r && (c = "copy"), e.shiftKey && l && (c = "move"), e.altKey && s && (c = "link"))), c;
  }
  ...
  /* Implement auto scrolling when drag cursor is in top/bottom area of scroll parent. */
  _autoScroll(e) {
    const n = this.tree, o = n.options.dnd.scrollSensitivity, r = n.element, s = n.headerElement.clientHeight, l = r.offsetHeight, c = r.scrollTop;
    return this.currentScrollDir = 0, c > 0 && e > 0 && e <= o + s ? this.currentScrollDir = -1 : c < r.scrollHeight - l && e >= l - o && (this.currentScrollDir = 1), this.currentScrollDir && this.applyScrollDirThrottled(), r.scrollTop - c;
  }
  ...
  onDragEvent(e) {
    ...
    if (["dragstart", "dragend"].includes(e.type) && this.tree.logDebug(`onDragEvent.${e.type} srcNode: ${o}`, e), e.type === "dragstart") {
      ...
      const s = o.toDict(!0, (l) => {
        l._orgKey = l.key, delete l.key;
      });
      s._treeId = o.tree.id, i.serializeClipboardData && (typeof i.serializeClipboardData == "function" ? e.dataTransfer.setData(An, i.serializeClipboardData(s, o)) : e.dataTransfer.setData(An, JSON.stringify(s))), !((n = e.dataTransfer) === null || n === void 0) && n.types.includes("text/plain") || e.dataTransfer.setData("text/plain", o.title), this.srcNode = o, setTimeout(() => {
  ...
  onDropEvent(e) {
    var n;
    const i = this.srcNode, o = i ? i.tree : null, r = _.getNode(e), s = this.treeOpts.dnd, l = e.dataTransfer, c = this._calcDropRegion(e, this.lastAllowedDropRegions), a = (f, b) => (f && this.tree.log(`Prevented drop operation (${b}).`), f);
    if (!r) {
      this._leaveNode();
      return;
    }
    if (["drop"].includes(e.type) && this.tree.logDebug(`onDropEvent.${e.type} targetNode: ${r}, ea: ${l == null ? void 0 : l.effectAllowed}, de: ${l == null ? void 0 : l.dropEffect}, cy: ${e.offsetY}, r: ${c}, srcNode: ${i}`, e), e.type === "dragenter") {
      ...
      const u = this.srcNode, p = this.lastDropEffect;
      setTimeout(() => {
  ...
  handleEvent(e) {
    ...
    switch (n) {
      ...
      case "mousedown":
        ...
        if (i.selector) {
          let r = e.target;
          if (r.matches(i.selector))
            this.dragElem = r;
          else if (r = r.closest(i.selector), r)
            this.dragElem = r;
          else
            break;
        }
...
function $c(t) {
  var e, n, i;
  const { _format: o, _keyMap: r = {}, _positional: s = [], children: l } = t;
  if (o !== "flat")
    throw new Error(`Expected source._format: "flat", but got ${o}`);
  if (s && s.includes("children"))
    throw new Error(`source._positional must not include "children": ${s}`);
  let c = r;
  if (r.t) {
  ...
  const a = s.map((g) => c[g]), f = [], b = {}, u = {}, p = (e = c.key) !== null && e !== void 0 ? e : "key", m = (n = c.children) !== null && n !== void 0 ? n : "children";
  for (const [g, N] of l.entries()) {
    const [T, V, M = {}] = N;
    N[1] = null, N[2] != null && (N[2] = null), V.forEach((Q, be) => {
      M[a[be]] = Q;
    }), u[g] = M;
    const I = M[p];
    I != null && (b[I] = M);
    ...
    if (T !== null) {
      if (typeof T == "number") {
        if (W = u[T], W === void 0)
          throw new Error(`unflattenSource: Could not find parent node by index: ${T}.`);
      } else if (W = b[T], W === void 0)
        throw new Error(`unflattenSource: Could not find parent node by key: ${T}`);
    }
    W ? ((i = W[m]) !== null && i !== void 0 || (W[m] = []), W[m].push(M)) : f.push(M);
  }
  t.children = f;
}
function ef(t) {
  ...
  function l(c) {
    for (const a of c)
      Object.getOwnPropertyNames(a).forEach((f) => {
        const b = a[f];
        let u = f;
        if (i && s[f] != null && (u = s[f], u !== f && (a[u] = b, delete a[f])), o && typeof b == "number" && o[u] != null) {
          const p = o[u][b];
          if (p == null)
            throw new Error(`Expected valueMap[${u}][${b}] entry in [${o[u]}]`);
          a[u] = p;
        }
...
class tf extends Et {
  constructor(e) {
    super(e, "grid", {
      ...
      // throttle: 400,
      dragstart: (n) => {
        const i = _.getEventInfo(n.startEvent), o = i.colDef, r = o && this.tree.element.contains(n.dragElem) && ht(o.resizable, e.options.columnsResizable, !1);
        if (this.tree.element.classList.toggle("wb-col-resizing", !!r), i.colElem.classList.toggle("wb-col-resizing", !!r), r) {
          ...
          n.customData.orgWidthPx = s, o.customWidthPx = s, this.tree.update(K.colStructure);
        }
        return r;
      },
  ...
  handleDrag(e) {
    ...
    if (e.type === "dragstop" || e.type === "drag") {
      if (this.tree.element.classList.remove("wb-col-resizing"), e.apply || e.type === "drag") {
        const o = Kr(i.minWidth, Gc), r = Math.max(o, n.orgWidthPx + e.dx);
        i.customWidthPx = r;
      } else
        this.tree.log("Column resize cancelled", e), i.customWidthPx = n.orgCustomWidthPx;
      this.tree.update(K.colStructure);
    }
  }
}
/*!
...
class Ke {
  ...
  *[Symbol.iterator]() {
  ...
  addChildren(e, n) {
    const i = this.tree;
    let { before: o = null, applyMinExpanLevel: r = !0, _level: s } = n ?? {};
    s ?? (s = this.getLevel());
    const l = [];
    try {
  ...
  setClass(e, n = !0) {
    ...
    if (n)
      this.classes === null && (this.classes = /* @__PURE__ */ new Set()), i.forEach((o) => {
        var r;
        this.classes.add(o), (r = this._rowElem) === null || r === void 0 || r.classList.toggle(o, n);
      });
    else {
      ...
      i.forEach((o) => {
        var r;
        this.classes.delete(o), (r = this._rowElem) === null || r === void 0 || r.classList.toggle(o, n);
  ...
  async expandAll(e = !0, n) {
    ...
    async function f(u, p) {
      var m;
      if (p === 0)
        return;
      const g = p == null ? null : p - 1, N = [];
      return (m = u.children) === null || m === void 0 || m.forEach((T) => {
        if (e)
          if (!T.expanded && (T.children || s && T.lazy)) {
            const V = T.setExpanded(!0, a);
            N.push(V), V.then(async () => {
              await f(T, g);
            });
          } else
            N.push(f(T, g));
        else
          (!o || l || T.getLevel() > o) && T.setExpanded(!1, a), f(T, g);
      }), new Promise((T) => {
        Promise.all(N).then(() => {
          T(!0);
        });
  ...
  *format_iter(e, n) {
    ...
    const o = (r) => {
      ...
      let l = r.parent;
      for (; l && l !== this; )
        s.unshift(n[i(l) ? 0 : 1]), l = l.parent;
      return s.join("");
    };
    yield e(this);
    for (const r of this)
...
`);
  ...
  getPath(e = !0, n = "title", i = "/") {
    let o;
    const r = [], s = typeof n == "function";
    return this.visitParents((l) => {
      l.parent && (o = s ? n(l) : l[n], r.unshift(o));
    }, e), r.join(i);
  }
  ...
  _loadSourceObject(e, n) {
    ...
    r != null && (e = r), Ft(e) && (e = { children: e }), z(ze(e), `Expected an array or plain object: ${e}`);
    const s = (i = e.format) !== null && i !== void 0 ? i : "nested";
    z(s === "nested" || s === "flat", `Expected source.format = 'nested' or 'flat': ${s}`), ef(e), z(e.children, "If `source` is an object, it must have a `children` property"), e.types && (o.logInfo("Redefine types", e.columns), o.setTypes(e.types, !1), delete e.types), e.columns && (o.logInfo("Redefine columns", e.columns), o.columns = e.columns, delete e.columns, o.update(K.colStructure)), this.addChildren(e.children);
  ...
  async load(e) {
    ...
    try {
      if (typeof e == "string" ? e : e.url) {
        ...
        if (l = Date.now() - r, this._requestId && this._requestId > i) {
  ...
  async loadLazy(e = !1) {
    ...
    if (z(this.lazy, "load() requires a lazy node"), !(!e && !this.isUnloaded())) {
      ...
      try {
        ...
        z(Ft(i) || i && i.url, "The lazyLoad event must return a node list, `{url: ...}`, or false."), await this.load(i), this.setStatus(me.ok), n ? (this.expanded = !0, this.tree.update(K.structure)) : this.update();
      } catch (i) {
  ...
  async makeVisible(e) {
    let n;
    const i = new Fr(), o = [], r = this.getParentList(!1, !1), s = r.length, l = hn(e, "noAnimation", !1), c = hn(e, "scrollIntoView", !0);
    for (n = s - 1; n >= 0; n--) {
  ...
  moveTo(e, n = "appendChild", i) {
    ...
    let o;
    const r = this.tree, s = this.parent, l = n === "appendChild" ? e : e.parent;
    if (this !== e) {
      if (this.parent ? l.isDescendantOf(this) && te("Cannot move a node to its own descendant") : te("Cannot move system root"), l !== s && s.triggerModifyChild("remove", this), this.parent.children.length === 1) {
        if (this.parent === l)
          return;
  ...
  removeChildren() {
    ...
    this.children && (!((e = i.activeNode) === null || e === void 0) && e.isDescendantOf(this) && i.activeNode.setActive(!1), !((n = i.focusNode) === null || n === void 0) && n.isDescendantOf(this) && i._setFocusNode(null), this.triggerModifyChild("remove", null), this.visit((o) => {
      i._unregisterNode(o);
    }), this.lazy ? this.children = [] : this.children = null, this.isRootNode() || (this.expanded = !1), this.tree.update(K.structure));
  }
  ...
  _getRenderInfo() {
    ...
    let r = 0;
    for (const s of this.tree.columns)
      e[s.id] = {
        id: s.id,
        idx: r,
        elem: o ? o[r] : null,
        info: s
      }, !i && s.id !== "*" && (n[s.id] = e[s.id]), r++;
    return {
      allColInfosById: e,
  ...
  _createIcon(e, n, i, o) {
    let r, s = this.getOption("icon");
    if (this._errorInfo ? s = e.error : this._isLoading && o && (s = e.loading), s === !1)
      return null;
    typeof s == "string" || (this.statusNodeType ? s = e[this.statusNodeType] : this.expanded ? s = e.folderOpen : this.children ? s = e.folder : this.lazy ? s = e.folderLazy : s = e.doc), s ? s.indexOf("<") >= 0 ? r = ln(s) : ho.test(s) ? r = ln(`<i class="wb-icon" style="background-image: url('${s}');">`) : (r = document.createElement("i"), r.className = "wb-icon " + s) : (r = document.createElement("i"), r.className = "wb-icon"), i ? n.replaceChild(r, i) : n.appendChild(r);
    const l = this._callEvent("iconBadge", { iconSpan: r });
    let c = null;
    if (l != null && l !== !1) {
      let a = "", f = "";
      ze(l) ? (c = "" + l.badge, a = l.badgeClass ? " " + l.badgeClass : "", f = l.badgeTooltip ? ` title="${l.badgeTooltip}"` : "") : typeof l == "number" ? c = "" + l : c = l, typeof c == "string" && (c = ln(`<span class="wb-badge${a}"${f}>${Yt(c)}</span>`)), c && r.append(c);
    }
    return r;
  }
  /**
  ...
  _render_markup(e) {
    ...
    let a, f = this._rowElem, b = null, u = null;
    const p = !f;
    ...
    let g = 0;
    r && (b = document.createElement("i"), b.classList.add("wb-checkbox"), (r === "radio" || this.parent.radiogroup) && b.classList.add("wb-radio"), m.appendChild(b), g += nn);
    for (let I = l - 1; I > 0; I--)
      a = document.createElement("i"), a.classList.add("wb-indent"), m.appendChild(a), g += nn;
    (!i.minExpandLevel || l > i.minExpandLevel) && (u = document.createElement("i"), u.classList.add("wb-expander"), m.appendChild(u), g += nn), this._createIcon(n.iconMap, m, null, !u) && (g += nn);
    const T = document.createElement("span");
    if (T.classList.add("wb-title"), m.appendChild(T), m._ofsTitlePx = g, n.options.dnd.dragStart && (m.draggable = !0), !this.isColspan() && s.length > 1) {
      let I = 0;
      for (const W of s) {
        I++;
        let Q;
        W.id === "*" ? Q = m : (Q = document.createElement("span"), Q.classList.add("wb-col"), f.appendChild(Q)), I === c && Q.classList.add("wb-active"), W.classes && Q.classList.add(...W.classes.split(" ")), Q.style.left = W._ofsPx + "px", Q.style.width = W._widthPx + "px", p && W.html && typeof W.html == "string" && (Q.innerHTML = W.html);
      }
    }
  ...
  _render_data(e) {
    ...
    const u = this.getOption("tooltip", !1);
    if (u && (f.title = u === !0 ? this.title : u), s && (n.element.scrollTop = b), !i.skeleton)
      if (c) {
        const p = n.element.clientWidth;
        f.style.width = p - a._ofsTitlePx - uo + "px";
      } else
  ...
  _render_status(e) {
    ...
    if (!e.isNew) {
      ...
      for (const p of s.children)
        p.classList.toggle("wb-active", b++ === n.activeColIdx), p.classList.remove("wb-error", "wb-invalid");
      const u = l.querySelector("i.wb-icon");
      u && this._createIcon(n.iconMap, l, u, !c);
    }
    if (e.resizeCols !== !1 && !this.isColspan()) {
      ...
      for (const m of this.tree.columns) {
        const g = b[u];
        g.style.left = `${p}px`, g.style.width = `${m._widthPx}px`, u++, p += m._widthPx;
      }
    }
  }
  /*
   ...
   */
  _render(e) {
    const n = Object.assign({ change: K.data }, e);
    switch (this._rowElem || (n.change = K.row), n.change) {
      case "status":
   ...
   */
  resetLazy() {
    this.removeChildren(), this.expanded = !1, this.lazy = !0, this.children = null, this.tree.update(K.structure);
  }
  ...
  toDict(e = !1, n) {
    ...
    if (gn.forEach((o) => {
      const r = this[o];
      r instanceof Set ? r.size && (i[o] = Array.prototype.join.call(r.keys(), " ")) : (r || r === !1 || r === 0) && (i[o] = r);
  ...
  getOption(e, n) {
    ...
    if (this[e] !== void 0)
      return this[e];
    const s = this.type ? i.types[this.type] : void 0, l = s ? s[e] : void 0;
    return l !== void 0 ? l : r ?? n;
  }
      ...
      if (e) {
        if (o !== this || r) {
          if ((o == null ? void 0 : o._callEvent("deactivate", {
            ...
            return;
          i._setActiveNode(null), o == null || o.update(K.status);
        }
      } else (o === this || r) && this._callEvent("deactivate", { nextNode: null, event: c });
    return o !== this && (e && i._setActiveNode(this), o == null || o.update(K.status), this.update(K.status)), this.makeVisible().then(() => {
  ...
  async setExpanded(e = !0, n) {
    const { force: i, scrollIntoView: o, immediate: r } = n ?? {}, s = !(n != null && n.noEvents);
   ...
   */
  update(e = K.data) {
    z(e === K.status || e === K.data, `Invalid change type ${e}`), this.tree.update(e, this);
  }
  /**
  ...
  fixSelection3FromEndNodes(e) {
    ...
    const i = (o) => {
      ...
      if (s && s.length) {
        ...
        r = !!o.selected;
      return o._partsel && !o.selected && o.lazy && o.children == null && (r = void 0), (n || !o.getOption("unselectable")) && o._changeSelectStatusProps(r), r;
    };
  ...
  setStatus(e, n) {
    ...
    const l = () => {
      ...
      return z(a.statusNodeType, "Not a status node"), z(!b || !b.isStatusNode(), "Child must not be a status node"), s = this.addNode(a, "prependChild"), s.match = !0, i.update(K.structure), s;
    };
    switch (l(), e) {
      case "ok":
        ...
        break;
      case "loading":
        this._isLoading = !0, this._errorInfo = null, this.parent ? this.update(K.status) : c({
          statusNodeType: e,
      ...
      case "error":
        c({
          ...
          // classes: "wb-center",
          tooltip: r
        }), this._isLoading = !1, this._errorInfo = { message: o, details: r };
        break;
      case "noData":
        c({
          statusNodeType: e,
  ...
  sortChildren(e = ri, n = !1) {
    this._sortChildren(e || ri, n), this.tree.update(K.structure);
  }
  /**
  ...
  resetNativeChildOrder(e) {
    ...
    this.children && this.children.forEach((o, r) => {
      o.data[i] = r, n && o.children && o.resetNativeChildOrder(e);
    });
  }
  /**
  ...
  sortByProperty(e) {
    ...
    const u = (p, m) => {
      let g, N;
      return gn.has(b) ? (g = p[b], N = m[b]) : (g = p.data[b], N = m.data[b]), g == null && N == null ? 0 : (g == null ? g = typeof N == "string" ? "" : 0 : typeof g == "boolean" && (g = g ? 1 : 0), N == null ? N = typeof g == "string" ? "" : 0 : typeof N == "boolean" && (N = N ? 1 : 0), r && (typeof g == "string" && (g = g.toLowerCase()), typeof N == "string" && (N = N.toLowerCase())), a === "desc" ? g === N ? 0 : g > N ? -1 : 1 : g === N ? 0 : g > N ? 1 : -1);
    };
    return this.sortChildren(u, s);
  }
  /**
  ...
  visit(e, n = !1) {
    ...
    if (n === !0 && (i = e(this), i === !1 || i === "skip"))
      return i;
    if (o)
      for (let r = 0, s = o.length; r < s && (i = o[r].visit(e, !0), i !== !1); r++)
        ;
    return i;
  }
...
class nf extends Et {
  ...
  async _applyChange(e, n, i, o, r) {
    return n.log(`_applyChange(${e})`, r), i.classList.add("wb-busy"), i.classList.remove("wb-error", "wb-invalid"), o.setCustomValidity(""), new Promise((s, l) => {
      ...
      if (s instanceof ii)
        n.logWarn("catched ", s), i.classList.add("wb-invalid"), o.setCustomValidity && !o.validationMessage && o.setCustomValidity(s.message), o.validationMessage && o.reportValidity();
      else
        throw n.logError(`Error in ${e} event handler (throw e.util.ValidationError instead if this was intended)`, s), i.classList.add("wb-error"), s;
    }).finally(() => {
  ...
  _preprocessKeyEvent(e) {
    const n = e.event, i = Ut(n), o = this.tree, r = this.getPluginOption("trigger");
  ...
  startEditTitle(e) {
    ...
    n && s.addEventListener("keydown", (l) => {
      s.setCustomValidity(""), s.reportValidity() || e.logWarn(`Invalid input: '${s.value}'`);
    }), s.focus(), i && s.select(), this.curEditNode = e, e._callEvent("edit.edit", {
      inputElem: s
    });
  }
  /**
  ...
  _stopEditTitle(e, n) {
    ...
    let r = o ? qi(o) : null;
    const s = this.curEditNode, l = !!n.forceClose, c = this.getPluginOption("validity");
    if (r && this.getPluginOption("trim") && (r = r.trim()), !s) {
    ...
    if (s.logDebug(`stopEditTitle(${e})`, n, o, r), e && r !== null && r !== s.title) {
      ...
      this._applyChange("edit.apply", s, f, o, {
        ...
        !l && b === !1 || (s == null || s.setTitle(r), (u = this.curEditNode) === null || u === void 0 || u._render({ preventScroll: !0 }), this.curEditNode = null, this.relatedNode = null, this.tree.setFocus());
      });
    } else
  ...
  createNode(e = "after", n, i) {
    const o = this.tree;
    if (n = n ?? o.getActiveNode(), z(n, "No node was passed, or no node is currently active."), e = e || "prependChild", i == null ? i = { title: "" } : typeof i == "string" ? i = { title: i } : z(ze(i), `Expected a plain object: ${i}`), (e === "prependChild" || e === "appendChild") && (n != null && n.isExpandable(!0))) {
      n.setExpanded().then(() => {
        this.createNode(e, n, i);
      });
      return;
    }
    const r = n.addNode(i, e);
    r.setClass("wb-edit-new"), this.relatedNode = n, r.match = !0, r.makeVisible({ noAnimation: !0 }).then(() => {
      this.startEditTitle(r);
    });
  }
}
/*!
...
class _ {
  ...
  constructor(e) {
    ...
    if (this.headerElement) {
      ...
      const s = "<span class='wb-col'></span>".repeat(this.columns.length);
    ...
    this.element.innerHTML += `
      ...
      n.navigationModeOption == null ? this.isGrid() ? this.setNavigationOption(he.cell) : this.setNavigationOption(he.row) : this.setNavigationOption(n.navigationModeOption), this.update(K.structure, { immediate: !0 }), i.resolve();
    }).catch((s) => {
      i.reject(s);
    }).finally(() => {
      var s;
      (s = this.element.querySelector("progress.spinner")) === null || s === void 0 || s.remove(), this.element.classList.remove("wb-initializing");
    })) : i.resolve(), this.update(K.any), this.element.addEventListener("scroll", (s) => {
      this.update(K.scroll);
    }), this.resizeObserver = new ResizeObserver((s) => {
      this.update(K.resize);
    }), this.resizeObserver.observe(this.element), je(this.element, "click", ".wb-button,.wb-col-icon", (s) => {
      var l, c;
      const a = _.getEventInfo(s), f = (c = (l = s.target) === null || l === void 0 ? void 0 : l.dataset) === null || c === void 0 ? void 0 : c.command;
      ...
      const l = _.getEventInfo(s), c = l.node, a = s;
      ...
      const l = _.getEventInfo(s), c = l.node;
      ...
      const l = _.getEventInfo(s), c = Ut(s), a = l.node || this.getFocusNode();
      ...
      const l = s.type === "focusin", c = _.getNode(s);
  ...
  *[Symbol.iterator]() {
  ...
  _callHook(e, n = {}) {
    ...
    for (const r of this.extensionList) {
      if (i = r[e].call(r, o), i === !1)
        break;
   ...
   */
  _callMethod(e, ...n) {
    const [i, o] = e.split("."), r = o ? this.extensions[i] : this, s = r[o];
    if (s)
      return s.apply(r, n);
   ...
   */
  _callEvent(e, n) {
    const [i, o] = e.split("."), r = this.options, s = o ? r[i][o] : r[i];
    if (s)
      return s.call(this, xe({ type: e, tree: this, util: this._util }, n));
  }
  ...
  getTopmostVpNode(e = !0) {
    const n = this.options.rowHeightPx, i = 1, r = this.element.scrollTop;
    let s;
    return e ? s = Math.ceil((r - i) / n) : s = Math.floor(r / n), this._getNodeByRowIdx(s);
  }
  /** Return the lowest visible node in the viewport. */
  getLowestVpNode(e = !0) {
    const n = this.options.rowHeightPx, i = this.element, o = this.headerElement.clientHeight, r = i.scrollTop, s = i.clientHeight - o;
    let l;
    return e ? l = Math.floor((r + s) / n) - 1 : l = Math.ceil((r + s) / n) - 1, l = Math.min(l, this.count(!0) - 1), this._getNodeByRowIdx(l);
  }
  ...
  applyCommand(e, n, i) {
    let o, r;
    switch (n instanceof Ke ? o = n : (o = this.getActiveNode(), z(i === void 0, `Unexpected options: ${i}`), i = n), e) {
      case "moveUp":
        r = o.getPrevSibling(), r && (o.moveTo(r, "before"), o.setActive());
        break;
      case "moveDown":
        r = o.getNextSibling(), r && (o.moveTo(r, "after"), o.setActive());
        break;
      case "indent":
        r = o.getPrevSibling(), r && (o.moveTo(r, "appendChild"), r.setExpanded(), o.setActive());
        break;
      case "outdent":
        o.isTopLevel() || (o.moveTo(o.getParent(), "after"), o.setActive());
        break;
      case "remove":
        r = o.getPrevSibling() || o.getParent(), o.remove(), r && r.setActive();
        break;
      case "addChild":
  ...
  /** Delete all nodes. */
  clear() {
    this.root.removeChildren(), this.root.children = null, this.keyMap.clear(), this.refKeyMap.clear(), this.treeRowCount = 0, this._activeNode = null, this._focusNode = null, this.update(K.structure);
  }
  /**
  ...
  getOption(e, n) {
    ...
    let r = o[e];
    return typeof r == "function" && (r = r({ type: "resolve", tree: this })), r ?? n;
  }
  /**
   * Set tree option.
  ...
  findNextNode(e, n) {
    let i = null;
    const o = this.getFirstChild(), r = typeof e == "string" ? _c(e) : e;
    n = n || o;
    function s(l) {
      if (r(l) && (i = l), i || l === n)
        return !1;
    }
    return this.visitRows(s, {
      start: n,
      includeSelf: !1
    }), !i && n !== o && this.visitRows(s, {
      start: o,
      includeSelf: !0
    }), i;
  }
  ...
  findRelatedNode(e, n, i = !1) {
    ...
    let r = null;
    const s = Math.floor(this.listContainerElement.clientHeight / o);
    switch (n) {
      case "parent":
        e.parent && e.parent.parent && (r = e.parent);
        break;
      case "first":
        this.visit((l) => {
          if (l.isVisible())
      ...
      case "left":
        ...
        break;
      case "right":
        e.children && e.children.length && (r = e.children[0]);
        break;
      case "up":
        r = this._getPrevNodeInView(e);
        break;
      case "down":
        r = this._getNextNodeInView(e);
        break;
      case "pageDown":
        {
          const l = this.getLowestVpNode();
          e._rowIdx < l._rowIdx ? r = l : r = this._getNextNodeInView(e, s);
        }
        break;
      case "pageUp":
        if (e._rowIdx === 0)
          ...
          e._rowIdx > l._rowIdx ? r = l : r = this._getPrevNodeInView(e, s);
        }
        break;
      default:
  ...
  *format_iter(e, n) {
  ...
  static getEventInfo(e) {
    const n = e.target, i = n.classList, o = n.closest("span.wb-col"), r = _.getNode(n), s = r ? r.tree : _.getTree(e), l = {
      event: e,
      canonicalName: Ut(e),
      tree: s,
      node: r,
    ...
    if (i.contains("wb-title"))
      ...
      l.region = r.isExpandable() ? ge.expander : ge.prefix;
      ...
      return e.type !== "mousemove" && !(e instanceof KeyboardEvent) && (s == null || s.logWarn("getEventInfo(): not found", e, l)), l;
    return l.colIdx === -1 && (l.colIdx = 0), l.colDef = s == null ? void 0 : s.columns[l.colIdx], l.colDef != null && (l.colId = l.colDef.id), l;
  }
  /**
   * Return readable string representation for this instance.
   * @internal
  ...
  scrollTo(e) {
    let i, o;
    e instanceof Ke ? i = e : (o = e, i = o.node), z(i && i._rowIdx != null, `Invalid node: ${i}`);
    const r = this.options.rowHeightPx, s = this.element, l = this.headerElement.clientHeight, c = s.scrollTop, a = s.clientHeight, f = i._rowIdx * r + l, b = l, u = f - c, p = u + r, m = o == null ? void 0 : o.topNode;
    let g = null;
    u >= b ? p <= a || (g = f + r - a + 2) : g = f - b - 2, g != null && (this.log(`scrollTo(${f}): ${c} => ${g}`), s.scrollTop = g, m && this.scrollTo(m));
  }
  /**
   ...
   */
  scrollToHorz() {
    const e = this.columns[0]._widthPx, n = this.element.clientWidth, i = this.element.scrollLeft, o = this.getActiveColElem(), r = Number.parseInt(o == null ? void 0 : o.style.left, 10), s = r + Number.parseInt(o == null ? void 0 : o.style.width, 10);
    let l = i;
    r - i < e ? l = r - e : s - i > n && (l = s - n), l = Math.max(0, l), this.log(`scrollToHorz(${this.activeColIdx}): ${r}..${s}, fixedOfs=${e}, vpWidth=${n}, curLeft=${i} -> ${l}`), this.element.scrollLeft = l;
  }
  /**
  ...
  setColumn(e, n) {
    ...
    (i = this.activeNode) === null || i === void 0 || i.update(K.status);
  ...
  update(e, n, i) {
    n instanceof Ke || (i = n, n = void 0);
    const o = !!hn(i, "immediate"), r = pn, s = this.pendingChangeTypes;
    ...
    s.size > 0 && (o ? this._updateViewportImmediately() : this._updateViewportThrottled());
  }
  ...
  setCellNav(e = !0) {
    ...
    this._cellNavMode = !!e, e && !i && this.setColumn(0), this.element.classList.toggle("wb-cell-mode", e), (n = this.activeNode) === null || n === void 0 || n.update(K.status);
  }
  ...
  setTypes(e, n = !0) {
    z(ze(e), `Expected plain objext: ${e}`), n ? this.types = e : xe(this.types, e);
  ...
  _updateColumnWidths() {
    ...
    for (const p of o) {
      ...
      if (!m || m === "*")
        ...
        p._widthPx != g && (a = !0, p._widthPx = g), c += g;
      } else
    ...
    for (const p of o) {
      ...
      if (p._weight) {
        ...
        const N = Math.max(m, f * p._weight / l);
        p._widthPx != N && (a = !0, p._widthPx = N);
      }
      p._ofsPx = b, b += p._widthPx;
    }
    o[o.length - 1]._widthPx -= i, s = b - i;
    const u = `${s}px`;
    return this.headerElement.style.width = u, this.listContainerElement.style.width = u, a;
  }
  _insertIcon(e, n) {
  ...
  _renderHeaderMarkup() {
    ...
    for (let r = 0; r < i; r++) {
      ...
      if (ht(s.menu, this.options.columnsMenu, !1)) {
        const u = `<i data-command=menu class="wb-col-icon ${"wb-col-icon-menu " + n.colMenu}"></i>`;
        a += u;
      }
      if (ht(s.sortable, this.options.columnsSortable, !1)) {
        ...
        const u = `<i data-command=sort class="wb-col-icon ${b}"></i>`;
        a += u;
      }
      if (ht(s.filterable, this.options.columnsFilterable, !1)) {
        ...
        const u = `<i data-command=filter class="wb-col-icon ${b}"></i>`;
        a += u;
      }
  ...
  _updateViewportImmediately() {
    ...
    if (this.pendingChangeTypes.clear(), o.has(i.scroll) && o.size === 1)
      ...
      if (this.log("_updateViewportImmediately():", o), this.options.adjustHeight !== !1) {
        let s = this.listContainerElement.clientHeight;
        const l = this.headerElement.clientHeight, c = this.element.clientHeight - l - n;
        Math.abs(s - c) > 1 && (this.listContainerElement.style.height = c + "px", s = c);
      }
      o.has(i.clearMarkup) && this.visit((s) => {
        s.removeMarkup();
  ...
  _updateRows(e) {
    ...
    const n = !!e.newNodesOnly, i = this.options.rowHeightPx, o = this.element.clientHeight, r = Jc, s = this.element.scrollTop;
    let l = Math.max(0, s / i - r);
    ...
    let f = 0, b = 0, u = !1, p = "first";
    this.visitRows(function(m) {
      const g = m._rowElem;
      m._rowIdx !== f && (m._rowIdx = f, u = !0), f < l || f > c ? g && (p = g) : g && n ? (a.delete(m), g.style.top = f * i + "px", p = g) : (a.delete(m), g && (g.style.top = f * i + "px"), m._render({ top: b, after: p }), p = m._rowElem), f++, b += i;
    }), this.treeRowCount = f;
    for (const m of a)
      m._callEvent("discard"), m.removeMarkup();
    return this.nodeListElement.style.height = `${b}px`, u;
  }
  /**
  ...
  visitRows(e, n) {
    ...
    const u = !!n.includeHidden, p = !u && this.filterMode === "hide";
    for (r = b.parent; r; ) {
      for (l = r.children, o = l.indexOf(b) + a, z(o >= 0, `Could not find ${b} in parent's children: ${r}`), i = o; i < l.length; i++) {
        if (b = l[i], b === c)
          return !1;
        if (!(p && !b.statusNodeType && !b.match && !b.subMatchCount) && (!f && e(b) === !1 || (f = !1, b.children && b.children.length && (u || b.expanded) && (s = b.visit((m) => {
          if (m === c)
            return !1;
          ...
          if (e(m) === !1)
            return !1;
          if (!u && m.children && !m.expanded)
            return "skip";
        }, !1), s === !1))))
          return !1;
      }
      b = r, r = r.parent, a = 1, !r && n.wrap && (this.logDebug("visitRows(): wrap around"), z(n.start, "`wrap` option requires `start`"), c = n.start, n.wrap = !1, r = this.root, a = 0);
    }
    return !0;
  }
  /**
   ...
   */
  _visitRowsUp(e, n) {
    let i, o, r, s = n.start || this.root.children[0];
    const l = !!n.includeHidden;
    if (n.includeSelf !== !1 && e(s) === !1)
      return !1;
    for (; ; ) {
      if (r = s.parent, i = r.children, i[0] === s) {
        if (s = r, !s.parent)
          break;
        i = r.children;
      } else
        for (o = i.indexOf(s), s = i[o - 1]; (l || s.expanded) && s.children && s.children.length; )
          i = s.children, r = s, s = i[i.length - 1];
      if (!(!l && !s.isVisible()) && e(s) === !1)
        return !1;
    }
    return !0;
  }
   ...
   */
  enableUpdate(e) {
    e ? (z(this._disableUpdateCount > 0, "enableUpdate(true) was called too often"), this._disableUpdateCount--, this._disableUpdateCount === 0 && (this.logDebug(`enableUpdate(): active again. Re-painting to catch up with ${this._disableUpdateIgnoreCount} ignored update requests...`), this._disableUpdateIgnoreCount = 0, this.update(K.any, { immediate: !0 }))) : this._disableUpdateCount++;
  }
  /* ---------------------------------------------------------------------------
   * FILTER
   * -------------------------------------------------------------------------*/
...
const rf = (t, e) => {
  ...
  created() {
    this.tree = null, this._anchorKey = null;
  },
  methods: {
    initTree() {
      var s, l;
      const t = this.$refs.treeContainer, e = /Mac|iP(hone|ad|od)/.test(navigator.platform || navigator.userAgent || ""), n = (c) => e ? c.altKey : c.ctrlKey;
      this._copyPressed = !1, this._onKeyDown = (c) => {
        this._copyPressed = n(c);
      }, this._onKeyUp = (c) => {
        this._copyPressed = n(c);
      ...
      const i = {
        ...
        click: (c) => {
          var a;
          if (c.node && (this.sendEvent("click", {
            key: c.node.key,
            title: c.node.title,
            data: c.node.data || {}
          }), ((a = c.info) == null ? void 0 : a.region) !== "expander"))
            return this.applySelectionClick(c.node, c.event, c.info || {}), !1;
        },
        dblclick: (c) => {
        ...
        keydown: (c) => {
          var f, b;
          const a = (f = c.event) == null ? void 0 : f.key;
          a === "Control" || a === "Shift" || a === "Alt" || a === "Meta" || this.sendEvent("keydown", {
            key: (b = c.node) == null ? void 0 : b.key,
            eventKey: a
          });
        },
        ...
        lazyLoad: (c) => {
          ...
          return new Promise((f, b) => {
            this._pendingLazyResolvers[a] = { resolve: f, reject: b };
            const u = setTimeout(() => {
              this._pendingLazyResolvers[a] && (delete this._pendingLazyResolvers[a], b(new Error(`Lazy load timeout for node: ${a}`)));
            }, 3e4);
            this._pendingLazyResolvers[a].timer = u, this.$emit("lazy-load", {
              key: a,
              title: c.node.title,
              data: c.node.data || {}
            });
        ...
        render: (c) => {
          var a, f;
          for (const b of Object.values(c.renderColInfosById || {}))
            if (b.id !== "*" && b.elem) {
              const u = ((a = c.node.data) == null ? void 0 : a[b.id]) ?? "";
              b.elem.querySelector("input, select") ? c.util.setValueToElem(b.elem, u) : b.elem.textContent = u;
            }
          {
            const b = c.node, u = b.data || {}, p = [`title: ${b.title}`], m = u.node_id;
            m && m !== b.title && p.push(`id: ${m}`);
            for (const [T, V] of Object.entries(u))
              T === "node_id" || T.startsWith("_") || V !== "" && V !== void 0 && V !== null && p.push(`${T}: ${V}`);
            const g = p.length > 1 ? p.join(`
`) : "";
            b.tooltip = g;
            const N = (f = c.nodeElem) == null ? void 0 : f.querySelector(".wb-title");
            N && (N.title = g);
          }
        },
        ...
        change: (c) => {
          var f;
          const a = (f = c.info) == null ? void 0 : f.colId;
          if (a) {
            const b = c.util.getValueFromElem(c.inputElem, !0);
            c.node.data[a] = b, c.node.update(), this.sendEvent("change", {
              key: c.node.key,
              colId: a,
              value: b,
              data: c.node.data || {}
      ...
      if (this.columns && this.columns.length > 0 && (i.columns = this.columns, i.columnsResizable === void 0 && (i.columnsResizable = !0)), i.edit && typeof i.edit == "object") {
        const c = { ...i.edit };
        i.edit = {
          ...c,
          beforeEdit: c.beforeEdit || ((a) => {
...
`)), c.event.dataTransfer.setData(Un, JSON.stringify(a)), c.event.dataTransfer.setData(go, this.treeId || ""), c.event.dataTransfer.effectAllowed = "copyMove"), this.sendEvent("dragStart", { key: c.node.key, keys: a }), !0;
        ...
        drop: (c) => {
          ...
          if (!a) return;
          const p = this.getDragNodes(a, f, b);
          if (!p.length) return;
          const m = (T) => {
            var V;
            return ((V = T.data) == null ? void 0 : V.node_id) || T.key;
          };
          if (u) {
            ...
            let T = f, V = b;
            for (const I of p)
              I.moveTo(T, V), (V === "after" || V === "prependChild") && (T = I, V = "after");
            const M = p[0].parent;
            this.sendEvent("drop", {
              sourceKey: a.key,
              ...
              region: b,
              movedNodeId: m(a),
              movedNodeIds: p.map(m),
              newParentNodeId: ((N = M == null ? void 0 : M.data) == null ? void 0 : N.node_id) || (M == null ? void 0 : M.key) || null
            }), this.emitSource();
          }
        }
      }), this.tree = new _(i);
      const o = (s = this.tree.extensions) == null ? void 0 : s.edit;
      if (o) {
        const c = this.tree.element, a = o._stopEditTitle.bind(o);
        o._stopEditTitle = function(f, b) {
          const u = c.querySelector("input.wb-input-edit");
          if (u) {
      ...
      const r = (l = this.tree.extensions) == null ? void 0 : l.grid;
      if (r && r.observer) {
        const c = r.observer, a = c._handler, f = c.handleEvent.bind(c), b = function(u) {
          if (u.type === "mousedown" && u.composedPath) {
            const p = u.composedPath()[0];
            if (p !== u.target) {
              const m = new Proxy(u, {
                get(g, N) {
                  if (N === "target") return p;
                  const T = g[N];
                  return typeof T == "function" ? T.bind(g) : T;
                }
              });
              return f(m);
            }
        ...
        c._handler = b, c.events.forEach((u) => {
          c.root.removeEventListener(u, a), c.root.addEventListener(u, b);
        });
      }
     ...
     */
    setSubtreeSelected(t, e) {
      var i, o;
      t.setSelected(e), (((o = (i = this.tree) == null ? void 0 : i.options) == null ? void 0 : o.selectMode) || "multi") === "multi" && t.visit((r) => {
        r.setSelected(e);
      });
    },
    deselectAll() {
      var t, e;
      for (const n of ((e = (t = this.tree) == null ? void 0 : t.getSelectedNodes) == null ? void 0 : e.call(t)) || [])
        n.setSelected(!1);
    },
    /**
    ...
    rangeKeys(t, e) {
      ...
      const n = [];
      let i = !1, o = !1;
      return (s = (r = this.tree) == null ? void 0 : r.visitRows) == null || s.call(r, (l) => {
        const c = l.key === t || l.key === e;
        if (!i)
          return c ? (i = !0, n.push(l.key), t === e ? (o = !0, !1) : void 0) : void 0;
        if (n.push(l.key), c)
          return o = !0, !1;
      }), o ? n : [];
    },
    /** Apply Windows Explorer click semantics, then move the active cell. */
    applySelectionClick(t, e, n) {
      const i = this.tree;
      if (!i) return;
      const o = !!(e && (e.ctrlKey || e.metaKey)), r = !!(e && e.shiftKey), s = t.isActive();
      i.runWithDeferredUpdate(() => {
        const a = r && this._anchorKey ? this.rangeKeys(this._anchorKey, t.key) : [];
        if (a.length) {
          o || this.deselectAll();
          for (const f of a) {
            const b = i.findKey(f);
            b && this.setSubtreeSelected(b, !0);
          }
          return;
        }
        o || n.region === "checkbox" ? this.setSubtreeSelected(t, !t.isSelected()) : (this.deselectAll(), this.setSubtreeSelected(t, !0)), this._anchorKey = t.key;
      }), n.colIdx >= 0 ? t.setActive(!0, { colIdx: n.colIdx, event: e }) : t.setActive(!0, { event: e });
      const l = i.getOption("edit.trigger") || [], c = i.getOption("edit.slowClickDelay");
      l.indexOf("clickActive") >= 0 && n.region === "title" && s && (!c || Date.now() - (i.lastClickTime || 0) < c) && t.startEditTitle();
    },
    getDragKeys(t) {
      var n, i;
      if (!t.isSelected()) return [t.key];
      const e = ((i = (n = this.tree) == null ? void 0 : n.getSelectedNodes) == null ? void 0 : i.call(n, !0)) || [];
      return e.length ? e.map((o) => o.key) : [t.key];
    },
    getDragNodes(t, e, n) {
      const i = this.getDragKeys(t).map((o) => {
        var r, s;
        return (s = (r = this.tree) == null ? void 0 : r.findKey) == null ? void 0 : s.call(r, o);
      }).filter((o) => !!o);
      return i.filter(
        (o) => !i.some((r) => r !== o && o.isDescendantOf(r)) && o !== e && !(e != null && e.isDescendantOf(o)) && !this.isNoOpDrop(o, e, n)
      );
    },
    /**
    ...
    effectiveRegion(t, e) {
      var i, o;
      return t !== "after" ? t : ((i = e == null ? void 0 : e.isExpanded) == null ? void 0 : i.call(e)) && !!((o = e.children) != null && o.length) ? "prependChild" : t;
    },
    /**
    ...
    isNoOpDrop(t, e, n) {
      ...
      switch (n) {
        ...
        case "appendChild":
          return t.parent === e;
        case "prependChild":
          return t.parent === e && ((i = e.children) == null ? void 0 : i[0]) === t;
        case "before":
          return e === t.getNextSibling();
        case "after":
          return e === t.getPrevSibling();
        default:
          return !1;
      }
    },
    ...
    emitSource() {
      this._emitSourcePending || (this._emitSourcePending = !0, setTimeout(() => {
        this._emitSourcePending = !1, this.$emit("change:source", this.getSerializableSource());
      }, 0));
    },
    ...
    moveNode(t, e, n) {
      ...
      if (i && o) {
        const r = n === "child" ? "appendChild" : n;
        i.moveTo(o, r), this.emitSource();
      }
    },
    updateNode(t, e) {
      if (!this.tree) return;
    ...
    moveNodeSilent(t, e, n) {
      if (!this.tree) return;
      const i = this.findByKey(t), o = this.findByKey(e), r = n === "child" ? "appendChild" : n;
      i && o && i.moveTo(o, r);
    },
...
function ff(t, e, n, i, o, r) {
  return ut(), Pt("div", {
    ...
    onClick: e[0] || (e[0] = (...s) => r.hideContextMenu && r.hideContextMenu(...s))
  }, [
    wi("div", lf, null, 512),
    o.ctxVisible ? (ut(), Pt("div", {
      ...
      (ut(!0), Pt(Ce, null, el(n.contextMenuItems, (s) => (ut(), Pt("div", {
        key: s.id,
        class: "wb-context-menu-item",
        onClick: dc((l) => r.onContextMenuItem(s.id), ["stop"])
      }, [
        s.icon ? (ut(), Pt("i", {
          key: 0,
          class: kn(s.icon)
...
function hf({ model: t, el: e }) {
  ...
  let i = !1;
  const o = t.get("source") || [], r = t.get("columns") || [], s = t.get("options") || {}, l = t.get("types") || {}, c = t.get("context_menu_items") || [], a = t.get("tree_id") || "", b = pc(af, {
    source: o,
    columns: r,
    options: s,
    types: l,
    ...
    "onChange:source": (u) => {
      console.debug("CHANGE:SOURCE (from JS)"), i = !0, t.set("source", u), t.save_changes();
    },
    "onTree-event": (u) => {
      console.debug("TREE-EVENT", u), u.timestamp = Date.now(), t.set("_event_data", u), t.save_changes();
    },
    "onFile-drop": (u) => {
      console.debug("FILE-DROP", u);
      const p = {
        event_name: "fileDrop",
        event_params: u,
        timestamp: Date.now()
      };
      t.set("_event_data", p), t.save_changes();
    },
    "onLazy-load": (u) => {
      console.debug("LAZY-LOAD", u), u.timestamp = Date.now(), t.set("_lazy_request", u), t.save_changes();
    },
    onReady: (u) => {
  ...
  t.on("change:source", () => {
    ...
    const u = t.get("_tree_action");
    u && u.action && b.handleTreeAction(u);
  }), t.on("change:_lazy_response", () => {
    console.debug("Python->JS: lazy response received");
    const u = t.get("_lazy_response");
    u && b.handleLazyResponse(u);
  });
}
export {
  hf as render
